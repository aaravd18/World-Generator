...
public class TETile {
    ...
    private static int newColorValue(int v, int dv, Random r) {
        ...
        int newValue = Math.min(x, Math.max(0, rawNewValue));
        return newValue;
    }
    ...
    public static class Avatar extends TETile {
        ...
        public Avatar(TETile tile, int x, int y, TETile[][] tiles){
            super(tile, 'w');
            this.x = x;
            this.y = y;
            this.tiles = tiles;
